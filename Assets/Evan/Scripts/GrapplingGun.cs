...
public class GrapplingGun : MonoBehaviour
{
    ...
    [HideInInspector] public bool attacking = false; //Holds if this grapple is for attacking
    [HideInInspector] public bool stopped = false; //Holds if this grappling is stopped
