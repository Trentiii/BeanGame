...
public class GrappleCopy : MonoBehaviour
{
    //--Editable varibles--
    ...
    //--Private references--
    private GunCopy grapplingGun; //Holds grapplingGunScript
    private LineRenderer lineRenderer; //Holds line renderer
    private Transform gunHolder; //Holds top parent
    private CopyMove pm; //Holds player movement script
    ...
    private void OnEnable()
    {
        ...
        {
            grapplingGun = transform.parent.GetComponent<GunCopy>();
